package com.huang.framework.utils;
...
public final class RedisUtil {
     ...
     * @return set差集
     */
    public Set sDifference(String key, List list) {
        try {
            Set set = redisTemplate.opsForSet().difference(key,list);
            return set;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public Set sUnion(String key1, String key2) {
        try {
            Set set = redisTemplate.opsForSet().union(key1, key2);
            return set;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public Object execute(RedisScript script, List keys, Object... objects){
        try {
